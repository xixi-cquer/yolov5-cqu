...
# runs again.  Do not edit this file unless you know what you are doing.
...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.groupBox_18.setStyleSheet("#groupBox_18{border-image: url(:/img/icon/background1.jpg);\n"
